...
const Learn = () => (
  <Layout>
    ...
    <Block marginTop="1.50rem">
      ...
      <Paragraph2>
        First generation crypto currencies like Bitcoin are based on a concept call proof of work. In a proof of work
        based blockchain, transactions are randomly processed by a mining node that is the first to solve a complex
        algorithm at the end of a time frame. Unfortunately, investors holding currencies like Bitcoin have no say in
        which network operator validates the transaction. This also leads to a certain level of centralization because
        proof of work based protocols take huge amounts of resources of operate and are usually dominated by large companies.
      </Paragraph2>

      <Paragraph2>
        In contrast to these first generation crypto currencies a much more efficient and distributed method of securing a blockchain, called Proof of Stake,
        ...
        require massive data centers preforming useless calculations to operate effectively. This new approach secures the blockchaing by
        randomly selecting miners or validators from a pool of operators based on the amount of digital currency that's been assigned to them.
        This process is called Staking, and has many advantages over proof of work based systems. Instead of wasting energy and computational
        resources, Proof of Stake systems are more efficient, salable, and democratic.
      </Paragraph2>
      ...
      <Paragraph2>
        ...
        the ability to provide our customers with the best available technologies and methods. In the future, we will continue to evaluate
        and offer our customers additional high quality options.
      </Paragraph2>

      <Paragraph2>
        <H6>What Is Cardano - ADA  ?</H6>
        <StyledLink href="https://www.cardano.org/en/home/" target="_blank"> Cardano </StyledLink>
        is home to the Ada crypto currency, which can be used to send and receive digital funds. This digital cash represents the future of money,
        making possible fast, direct transfers that are guaranteed to be secure through the use of cryptography. Cardano is more than just a crypto currency,
        however, it is a technological platform that will be capable of running financial applications currently used every day by individuals, organizations
        ...
        smart contracts, the digital legal agreements that will underpin future commerce and business. Cardano will also run decentralized applications, or dapps,
      ...
      <Paragraph2>
        ...
        thought and care from some of the leading experts in their fields has been devoted to the project and informed design decisions. The scientific rigor applied
        to mission-critical systems such as aerospace and banking has been brought to the field of crypto currencies, with a high assurance implementation. We believe
